          ...
          <div>
            ...
            <div class="for-justify-btwe  relative pr-0 ">
              <div class="pl-0 p-6 pt-5   w-100">
                <h1 class="font-semibold text-1xl">Get Quote</h1>
                <p class=" pt-1 sm:mt-6 md:mt-0 lg:mt-0 ">
                  You can check or create your new orders , ready toManifest Get Quote
                  and track an orders
                </p>
              </div>
        ...
        <section class="mt-4">
          ...
          >
            ...
            <div class="inside-content">
              <boxShare
                heading="You currently have no new Get Quote"
                title="You can check for new Get Quote by syncing with your ecommerce integration."
              />
